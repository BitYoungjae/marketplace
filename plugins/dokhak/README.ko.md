...
| 커맨드                | 설명                               | 사용 시점                 |
| --------------------- | ---------------------------------- | ------------------------- |
| `/dokhak:add-chapter` | 새 챕터 추가                       | 커리큘럼 확장 시          |
| `/dokhak:add-section` | 기존 챕터에 섹션 추가              | 세부 내용 추가 시         |
...
```bash
/dokhak:add-chapter "<챕터명>" --part <파트번호> --pages <페이지수>
```

- `<챕터명>`: 추가할 챕터 제목 (필수)
- `--part`: 챕터를 추가할 파트 번호 (필수)
- `--pages`: 챕터에 할당할 페이지 수 (필수)

#### `/dokhak:add-section`

```bash
/dokhak:add-section "<섹션명>" --chapter <챕터번호> --pages <페이지수>
```

- `<섹션명>`: 추가할 섹션 제목 (필수)
- `--chapter`: 섹션을 추가할 챕터 번호 (필수)
- `--pages`: 섹션에 할당할 페이지 수 (필수)
